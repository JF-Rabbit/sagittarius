 ...
 * 用来随机生成一个中文名的方法类
 * 
 * @author jasonzhang 2016年11月3日 上午11:32:03
 *
 */
public class ChineseName {
	...
	public static String getSimpleName() {
		...
		String[] temp = new String[] { "零", "一", "二", "三", "四", "五", "六", "七", "八", "九" };
		/* 从常用字中选取一个或两个字作为名 */
		if (random.nextBoolean()) {
			name += temp[(new Random().nextInt(10))] + temp[(new Random().nextInt(10))];
		} else {
			name += temp[(new Random().nextInt(10))];
		}
		return name;
	}
